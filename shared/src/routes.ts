...
export const APP_ROUTES: AppRouteDefinition[] = [
  ...
  { path: "/audit", name: "Audit log", access: "admin", requiredCapabilities: [], implemented: true },
  { path: "/settings", name: "Settings", access: "authenticated", requiredCapabilities: ["studio.view"], implemented: true, notes: "Studio profile (Admin) and studio-wide business prefs (Admin/AE); studio SMTP is on Team (Admin-only)." },
