...
export const APP_ROUTES: AppRouteDefinition[] = [
  ...
  { path: "/team", name: "Team", access: "admin", requiredCapabilities: ["team.manage"], implemented: false },
  ...
  { path: "/profile", name: "Profile", access: "authenticated", requiredCapabilities: ["studio.view"], implemented: true, notes: "Placeholder screen today." },
