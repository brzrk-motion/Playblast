...
> Looking to fund the project? See [SPONSORS.md](SPONSORS.md). Open Collective (via OSC) is the planned primary channel once accepted; GitHub Sponsors is secondary and pending org enablement. No live checkout until OSC publishes the canonical URL.
