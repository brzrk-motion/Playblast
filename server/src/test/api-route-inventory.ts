...
export const API_ROUTES: ApiRouteDefinition[] = [
  ...
  { method: "GET", path: "/api/audit-events", access: "admin", requiredCapabilities: [] },
  { method: "GET", path: "/api/audit-events/export", access: "admin", requiredCapabilities: [] },
  ...
  { method: "GET", path: "/api/projects/:projectId/tasks", access: "authenticated", requiredCapabilities: ["projects.view"] },
   { method: "GET", path: "/api/projects/:projectId/hours-summary", access: "authenticated", requiredCapabilities: ["business.manage"] },
  ...
  { method: "POST", path: "/api/uploads/tus", access: "authenticated", requiredCapabilities: ["media.upload"], notes: "Tus resumable upload create" },
  { method: "PATCH", path: "/api/uploads/tus/:uploadId", access: "authenticated", requiredCapabilities: ["media.upload"], notes: "Tus resumable upload chunk" },
  ...
  { method: "GET", path: "/video/:projectId/:deliverableId/:version/:filename", access: "authenticated", requiredCapabilities: ["review.play"] },
   { method: "GET", path: "/api/leads", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "POST", path: "/api/leads", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/leads/:id", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "PATCH", path: "/api/leads/:id", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "DELETE", path: "/api/leads/:id", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/leads/:id/log", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "POST", path: "/api/leads/:id/log", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "DELETE", path: "/api/leads/:id/log/:logId", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "POST", path: "/api/leads/:id/convert", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/clients", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "POST", path: "/api/clients", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/clients/:id", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "PATCH", path: "/api/clients/:id", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "DELETE", path: "/api/clients/:id", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "PATCH", path: "/api/clients/:id/retainer-hours", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "POST", path: "/api/clients/:id/revert-to-lead", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/services", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "POST", path: "/api/services", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "PUT", path: "/api/services/:id", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "DELETE", path: "/api/services/:id", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/services/:id/usage", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/projects/:projectId/milestones", access: "authenticated", requiredCapabilities: ["projects.view"] },
   ...
   { method: "GET", path: "/api/milestones/:milestoneId/tasks", access: "authenticated", requiredCapabilities: ["projects.view"] },
   ...
   { method: "GET", path: "/api/tasks/:taskId/time-logs", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "POST", path: "/api/tasks/:taskId/time-logs", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "PATCH", path: "/api/time-logs/:timeLogId", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "DELETE", path: "/api/time-logs/:timeLogId", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/timesheet", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/projects/:projectId/services", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "POST", path: "/api/projects/:projectId/services", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "PATCH", path: "/api/projects/:projectId/services/:serviceId", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "DELETE", path: "/api/projects/:projectId/services/:serviceId", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/projects/:projectId/invoices", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "POST", path: "/api/projects/:projectId/invoices", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/invoices/:invoiceId", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "PATCH", path: "/api/invoices/:invoiceId", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/invoices/:invoiceId/payments", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "POST", path: "/api/invoices/:invoiceId/payments", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/invoices/:invoiceId/pdf", access: "authenticated", requiredCapabilities: ["business.manage"] },
   { method: "GET", path: "/api/invoices/:invoiceId/download", access: "authenticated", requiredCapabilities: ["business.manage"] },
]
